    ...
    <Layout title="Home" noHeader>
        ...
        <div className="flex mx-auto max-w-7xl space-x-16">
          ...
          <div className="items-center hidden xl:flex">
            <Image
              ...
              width={683}
              height={1024}
              alt="One yogi on the back of another, smiling"
              layout="intrinsic"
            />
          </div>
        </div>
      ...
      <div className="flex flex-col-reverse items-center max-w-6xl px-4 pt-12 mx-auto sm:px-6 md:flex-row">
        <div className="flex flex-1 mt-8 lg:ml-12">
          <Image
            src="/mindBodyApp.jpg"
            alt="MINDBODY app displayed on mobile device"
            height={468}
            width={455}
            layout="intrinsic"
          />
      ...
      {/* ----- Contact Us ----- */}
      <div className="px-4 bg-brand-blue sm:px-6">
        <div className="flex flex-col justify-between max-w-5xl py-8 mx-auto sm:py-16 lg:flex-row space-y-8 lg:space-y-0">
          <div>
          ...
          <div className="space-y-8 md:space-y-0 sm:grid sm:grid-cols-2 sm:gap-8 sm:space-y-0 md:grid md:grid-cols-3 lg:flex lg:flex-col">
            <div className="sm:row-span-1 sm:col-span-full space-y-8 sm:grid sm:grid-cols-2 sm:space-y-0 sm:space-x-4 lg:flex lg:flex-col lg:space-x-0 lg:space-y-8">
              ...
              <div className="space-y-8 md:order-2 sm:space-y-4 lg:space-y-8">
                <div className="">
                  <small className="text-xs tracking-wider text-gray-100 uppercase">
                    Hours
                  </small>
            ...
            <div className="sm:row-span-2 sm:col-span-full">
              <div className="md:order-2 space-y-8 sm:grid sm:gap-2 sm:grid-cols-2 sm:col-span-full sm:space-y-0 sm:space-x-4 lg:flex lg:flex-col lg:space-x-0 lg:space-y-4">
                <div>
                  <small className="text-xs tracking-wider text-gray-100 uppercase">
                    Email Address
                  </small>
