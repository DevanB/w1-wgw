...
export function Footer() {
  return (
    <footer className="flex items-center px-4 py-4 bg-brand-blue md:py-8">
      <div className="flex flex-col items-center mx-auto max-w-7xl space-y-10 md:grid md:grid-cols-3 md:gap-8 md:gap-y-12 md:space-y-0">
        <div className="md:order-3 md:flex md:items-center md:justify-center">
          <Image
        ...
        <div className="flex flex-col items-center md:order-1 md:justify-center">
          ...
          <div className="flex mt-3">
            <a
              ...
              className="mr-3 text-gray-100 hover:text-gray-300"
            >
